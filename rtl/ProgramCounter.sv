...
(
    ...
    input  mem_addr_t addrLoad,   // value to set the next address to
    output mem_addr_t addrOut     // the address of the instruction currently being fetched
);

    localparam mem_addr_t INCREMENT = 32'd4;
    mem_addr_t addrNext;
